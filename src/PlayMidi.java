package midiAlong;
/*A small program to add MidiEvents to an existing track courtesy of Andrew Thompson"
 * https://stackoverflow.com/questions/27987400/how-to-get-note-on-off-messages-from-a-midi-sequence
 */
...
class PlayMidi {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        File path = new File("National_Anthems_-_United_States.mid");
        ...
        MetaEventListener mel = new MetaEventListener() {
            ...
            public void meta(MetaMessage meta) {
                ...
                final byte [] msg = meta.getData();
                int note = ((msg[1] & 0x0F) << 4);
        ...
        ControllerEventListener cel = new ControllerEventListener() {
            ...
            public void controlChange(ShortMessage event) {
                ...
                if (command == ShortMessage.NOTE_ON) {
                    ...
                    int note = ((event.getData2() & 0x0F) << 4);
                    System.out.println(note);
                } else if (command == ShortMessage.NOTE_OFF) {
